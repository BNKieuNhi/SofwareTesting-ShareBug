...
WebUI.click(findTestObject('Object Repository/Add module/Page_ShareBug - Modules/img_Modules ()_mb-1'))
...
WebUI.click(findTestObject('Object Repository/Add module/Page_ShareBug - Modules/a_Dashboard'))
